...
# First task is to load the cleaned dataset
...
class DataFrameInfo:
    ...
    def describe_columns(self):
        """Describes all columns and their data types."""
    ...
    def statistical_values(self):
        """Extracts statistical values (mean, std, median) from numeric columns."""
        ...
        print("\nMedian:")
        print(self.df.select_dtypes(include=['number']).median())
        print("\n")

    # Here, this method extracts a count of distinct values in categorical columns
    def count_distinct_values(self):
        """Extracts a count of distinct values in categorical columns."""
    ...
    def count_null_values(self):
        """Provides counts and percentages of NULL values in each column."""
